                    ...
                    <View style={styles.content}>
                        ...
                        <Menu
                            ...
                            anchor={
                                <Button
                                    mode="outlined"
                                    onPress={() => setTaskTypeMenuVisible(true)}
                                    icon="chevron-down"
                        ...
                        >
                            <Menu.Item
                                title="Tutoring"
                                onPress={() => handleSelectTaskType("tutoring")}
                            />
                            <Menu.Item
                                title="Delivery"
                                onPress={() => handleSelectTaskType("delivery")}
                            />
                            <Menu.Item
                                title="Freelance"
                                onPress={() =>
                                    handleSelectTaskType("freelance")
                                }
                            />
                            <Menu.Item
                                title="Moving"
                                onPress={() => handleSelectTaskType("moving")}
                            />
                            <Menu.Item
                                title="Tech support"
                                onPress={() =>
                                    handleSelectTaskType("tech_support")
                                }
                            />
                            <Menu.Item
                                title="General"
                                onPress={() => handleSelectTaskType("general")}
                            />
                            <Menu.Item
                                title="Other"
                                onPress={() => handleSelectTaskType("other")}
                            />
                        </Menu>
                        {errors.type && (
                            <Text style={{ color: "red" }}>
                        ...
                        <View style={{ alignItems: "center" }}>
                            <Button
                                ...
                                loading={isPending}
                            >
                                {isPending ? "Submitting..." : "Post Task"}
                            </Button>
                        </View>
                    </View>
                </ScrollView>
