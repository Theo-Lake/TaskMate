...
export default function LoginScreen({ navigation }: any) {
    ...
    return (
        <View style={styles.container}>
            ...
            <KeyboardAvoidingView /*for pushing the screen up when the keyboard appears so you can see what you're typing*/
                behavior={Platform.OS === 'ios' ? 'padding' : 'height'}
                style={{ flex: 1 }}
            >
                <ScrollView /*for allowing scrolling and being able to tap outside of the box to exit the keyboard instead of pressing return*/
                ...
                >
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={{ padding: 20 }}>
                            <TextInput mode='outlined' label="University Email" value={emailText} onChangeText={text => setEmailText(text)} style={styles.textBox} error={!!errors.email} />
